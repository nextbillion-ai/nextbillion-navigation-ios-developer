...
#ifndef NAVIGATIONDATARECORDIOS_SWIFT_H
#define NAVIGATIONDATARECORDIOS_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="NavigationDataRecordIOS",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_RESILIENT_CLASS_NAMED("NavReplayLocationManager")
...
SWIFT_CLASS("_TtC23NavigationDataRecordIOS34NavigationRecrodDataViewController")
@interface NavigationRecrodDataViewController : UIViewController <UITableViewDataSource, UITableViewDelegate>
